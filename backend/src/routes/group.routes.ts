 ...
 * @access  Private
 */
router.get('/status', authMiddleware, asyncHandler(async (req, res, next): Promise<void> => {
 ...
 * @access  Private
 */
router.post('/vote/:groupId', authMiddleware, asyncHandler(async (req, res, next): Promise<void> => {
 ...
 * @access  Private
 */
router.post('/leave/:groupId', authMiddleware, asyncHandler(async (req, res, next): Promise<void> => {
